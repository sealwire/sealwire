...
pub struct AskView {
    ...
    pub title: String,
    /// One-line result preview (160 Unicode scalars at most, plus an ellipsis when cut).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub result: Option<String>,
    /// Legacy alias of `title` for older Agents panels.
    pub message: String,
    /// Legacy alias of `result` for older Agents panels.
